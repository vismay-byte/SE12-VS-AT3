...
- `aerodromes.json` was **added in Stage 3.** 8 Sydney Basin aerodromes (YSBK, YSCN, YSSY,
...
- `waypoints.json` was **added in Stage 4.** 14 common Sydney Basin VFR reporting
...
- `checklists.json` was added in Stage 11
