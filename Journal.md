...
### Aim for Next Week
Finish the Software Evaluation (Performance and Security sections), complete the Test Report's Unit, System, Performance, and Security testing write-ups using DevTools and OWASP ZAP, and fix the four logged bugs.
